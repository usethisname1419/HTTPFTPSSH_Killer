...
def http_attack(ip, user, password, http_post_params, success_pattern, failure_pattern, success_content_length=None,
    ...
    try:
        ...
        verbose_print(f"{Fore.WHITE}[{Fore.CYAN}HTTP-CONTENT-LENGTH{Fore.WHITE}]{Fore.RESET}: {len(response.content)}\n")
...
def https_attack(ip, user, password, https_post_params, success_pattern, failure_pattern,
    ...
    try:
        ...
        verbose_print(f"{Fore.WHITE}[{Fore.CYAN}HTTPS-CONTENT-LENGTH{Fore.WHITE}]{Fore.RESET}: {response_length}\n")
